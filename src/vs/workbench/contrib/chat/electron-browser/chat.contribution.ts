...
import { ForgeToolsContribution } from './forgeTools/forgeTools.js';
...
registerWorkbenchContribution2('chat.forgeTools', ForgeToolsContribution, WorkbenchPhase.AfterRestored);
